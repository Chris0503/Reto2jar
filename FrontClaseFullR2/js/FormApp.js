...
const url_linkProducts = "http://localhost:8080/api/hairproducts/";
        ...
        success: function(data){
            if(data.length > 0){
                ...
                for(i=0;i<data.length;i++){
                    ...
                    //$row.append($("<td class='text-center no-padding'>").append('<button type="button" class="btn btn-warning" onclick="editProducto()">Editar producto</button>'));
                    //$row.append($("<td class='text-center no-padding'>").append('<button type="button" class="btn btn-danger" onclick="deleteProducto()">Eliminar producto</button>'));
...
function getProductsModal(){
    $.ajax({
        ...
        success: function(data){
            ...
            $filas = $('<tr>');
            $filas.append($('<td>').append("<input type='text' placeholder='reference' id='reference'/>"));
            $filas.append($('<td>').append("<input type='text' placeholder='brand' id='brand'/>"));
            $filas.append($('<td>').append("<input type='text' placeholder='category' id='category'/>"));
            $filas.append($('<td>').append("<input type='text' placeholder='name' id='name'/>"));
            $filas.append($('<td>').append("<input type='text' placeholder='description' id='description'/>"));
            $filas.append($('<td>').append("<input type='text' placeholder='availability' id='availability'/>"));
            $filas.append($('<td>').append("<input type='text' placeholder='price' id='price'/>"));
            $filas.append($('<td>').append("<input type='text' placeholder='quantity' id='quantity'/>"));
            $filas.append($('<td>').append("<input type='text' placeholder='photography' id='photography'/>"));
            $("#listaproductos").append($filas);
